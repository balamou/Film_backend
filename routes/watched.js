...
router.get("/watched/:userid", (req, res, next) => {
    ...
    const watched = [
        { id: 3, duration: 100, stoppedAt: 80, label: "1h 3min", movieURL: basePath + "/en/shows/E03.mkv", type: TYPE_MOVIE, posterURL: posters[0]},
        { id: 2, duration: 100, stoppedAt: 80, label: "S3:E4", movieURL: basePath + "/en/shows/E02.mp4", type: TYPE_SHOW, posterURL: posters[1]}
    ];
